 ...
 *
 */
public class PrepaymentFeeUnit implements IProductUnit {

    private final  String MODULE_NAME  ="prepaymentFee";


    private final  String MODULE_NAME_ZH="提前还款手续费";
