...
public class NotifyTemplateUnit implements IProductUnit{
	private final  String MODULE_NAME  ="notifyTemplate";


    private final  String MODULE_NAME_ZH="通知模板管理";
