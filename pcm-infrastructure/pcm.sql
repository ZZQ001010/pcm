...
DROP TABLE IF EXISTS PCM_SETTLE_ACC_MAN;
...
-- 结算账户管理
CREATE TABLE PCM_SETTLE_ACC_MAN
(
	SETTLE_ACC_CODE VARCHAR(100) NOT NULL COMMENT '结算账号编码',
	SETTLE_ACC_DES VARCHAR(200) COMMENT '结算账号描述',
	-- ///@EnumRef:cn.sunline.pcm.definition.enums.AccountOwner
	-- F|资金方
	-- A|资产方
	-- O|自有
	ACCOUNT_OWNER CHAR(3) COMMENT '账号归属',
	UNIFIED_SOC_CRE_CODE VARCHAR(100) COMMENT '统一社会信用代码',
	ORG_CODE VARCHAR(100) COMMENT '机构编号',
	ACC_INFO VARCHAR(200) COMMENT '账号信息',
	ACC_NOTE_NAME VARCHAR(32) COMMENT '账户备注名',
	PUB_OPEN_NUM VARCHAR(100) COMMENT '对公账户的开户行号',
	OPEN_BANK VARCHAR(100) COMMENT '开户银行',
	OPEN_BANK_PROV VARCHAR(32) COMMENT '开户银省份',
	OPEN_BANK_CITY VARCHAR(32) COMMENT '开户行城市',
	OPEN_BANK_BRANCH VARCHAR(100) COMMENT '开户行支行',
	PRIMARY KEY (SETTLE_ACC_CODE)
) COMMENT = '结算账户管理';
