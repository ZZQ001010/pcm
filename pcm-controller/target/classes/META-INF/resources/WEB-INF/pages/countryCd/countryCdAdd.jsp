...
<title><spring:message code="countryCd.add.title" text="国家代码管理新增" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="countryCdAddForm" cssStyle="padding-top: 40px" modelAttribute="countryCd" method="post" action="${ctx}/countryCd/addCountryCd.in" data-confirm="true">
