...
<title><spring:message code="branch.update.title" text="分支机构修改" /></title>
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="branchUpdForm" cssStyle="padding-top: 40px;padding-left: 10px" modelAttribute="branch" method="post" action="${ctx}/branch/updBranch.in" data-confirm="true">
		...
		<div class="form-group row">
			<!-- 机构所在区 -->
			<label class="col-lg-2 col-md-2 col-sm-2 col-xs-4 control-label"> <spring:message code="branch.district" text="机构所在区" /> :
			</label>
			<div class="col-lg-7 col-md-7 col-sm-7 col-xs-6">
		...
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<div class="form-group row">
					...
					<div class="col-lg-7 col-md-7 col-sm-7 col-xs-6">
						<form:select cssClass="form-control" data-rule-required="true" path="acctProvince">
				...
				<div class="form-group row">
					...
					<div id="acctCityBox" class="col-lg-7 col-md-7 col-sm-7 col-xs-6">
						<form:select cssClass="form-control" data-rule-required="true" path="acctCity">
	...
	$("#acctProvince").bind("change",function(){
		$.ajax({
		        ...
		        {		
		        	...
		        	$("#acctCityBox").empty();
				$("#acctCityBox").append(`
					<select id="acctCity" class="form-control" data-rule-required="true" name="acctCity">
