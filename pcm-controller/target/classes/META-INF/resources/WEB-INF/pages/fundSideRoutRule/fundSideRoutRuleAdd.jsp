...
<title><spring:message code="fundSideRoutRule.add.title" text="资产方路由规则新增" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="fundSideRoutRuleAddForm" cssStyle="padding-top: 40px" modelAttribute="fundSideRoutRule" method="post" action="${ctx}/fundSideRoutRule/addFundSideRoutRule.in" data-confirm="true">
		...
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:input cssClass="form-control" type="text" path="xinBaoProduct"  data-rule-maxlength="200" />
			</div>
			<!-- 资金方基本信息中的资金方编码-描述描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="fundSideRoutRule.xinBaoProduct.desc" />
			</div>
		</div>
		<div class="form-group row">
			<!-- 路由规则编码 -->
	...
	<script type="text/javascript">
		//开启表单验证
		$("#fundSideRoutRuleAddForm").validate();
	</script>
</body>
</html>