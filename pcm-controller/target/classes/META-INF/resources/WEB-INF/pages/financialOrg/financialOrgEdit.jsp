...
<title><spring:message code="financialOrg.update.title" text="合作机构修改" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="financialOrgUpdForm" cssStyle="padding-top: 40px;padding-right: 40px" modelAttribute="financialOrg" method="post" action="${ctx}/financialOrg/updFinancialOrg.in" data-confirm="true">
		<div class="x_panel">
			<div class="x_title">
				<h2>
			...
			<div class="x_content">
				<div class="form-group row col-lg-4 col-md-6 col-sm-10 col-xs-10 ">
					...
					<div class="col-lg-6 col-md-6  col-sm-6 col-xs-6"><!-- <spring:message code='financialOrg.financialOrgNO.desc'  text='金融机构编码描述'/> -->
			...
			<div class="form-group row col-lg-4 col-md-6 col-sm-10 col-xs-10 ">
				...
				<div class="form-group row col-lg-12 col-md-12 col-sm-10 col-xs-10">
					...
					<label class="col-lg-2 col-md-3 col-sm-6 col-xs-6 control-label">
						<spring:message code="financialOrg.externalCutCompInd" text="外部扣款是否强制不对账" />:</label>
					...
					<!-- 外部放款是否强制不对账 -->
					<label class="col-lg-2 col-md-3 col-sm-6 col-xs-6 control-label">
						<spring:message code="financialOrg.externalLoanCompInd" text="外部放款是否强制不对账" />:</label>
					<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6" style="margin-top:8px; ">
						<input id="externalLoanCompInd" type="checkbox" class="js-switch" unchecked />
				...
				<!-- 直接扣款是否强制不对账 -->
					<label class="col-lg-2 col-md-3 col-sm-6 col-xs-6 control-label">
						<spring:message code="financialOrg.derectCutCompInd" text="直接扣款是否强制不对账" />:</label>
					<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6" style="margin-top:8px;">
					...
					<!-- 直接放款是否强制不对账 -->
					<label class="col-lg-2 col-md-3 col-sm-6 col-xs-6 control-label">
						<spring:message code="financialOrg.derectLoanCompInd" text="直接放款是否强制不对账" />:</label>
					<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6" style="margin-top:8px; ">
		...
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<div class="form-group row col-lg-4 col-md-6 col-sm-10 col-xs-10 ">
					...
					<div id="payCityBox"class="col-lg-4 col-md-4  col-sm-6 col-xs-12">
	...
	$("#province").on("change",function(){
				$.ajax({
	  		        ...
	  		        {		
	  		        	$("#cityBox").empty();
						$("#cityBox").append(`<select id="city" class="form-control" name="city"><option value="">--- 请选择 --- </option></select>`); 
						for (var key in data) {
	...
	//开户城市
	$("#acctProvince").on("change",function(){
		$.ajax({
		        type: "post",
		        url: "${ctx}/webCommon/loadCity.in ",
		        cache: false,
		        ...
		        {		
		        	$("#acctCityBox").empty();
				$("#acctCityBox").append(`<select id="acctcity" class="form-control" name="acctcity"><option value="">--- 请选择 --- </option></select>`); 
				for (var key in data) {
	...
	//开户城市2号	
		$("#payProvince").on("change",function(){
		...
		$.ajax({
		        ...
		        {		
		        	$("#payCityBox").empty();
				$("#payCityBox").append(`<select id="paycity" class="form-control" name="paycity"><option value="">--- 请选择 --- </option></select>`); 
				for (var key in data) {
		        		$("#paycity").append(`<option value=`+key+`>`+data[key]+`</option>`);
		        	}
		        }
