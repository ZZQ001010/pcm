...
<title><spring:message code="fundSideInfo.update.title" text="资金方基本信息
修改" /></title>
<%@ include file="/common/head.jsp"%>
</head>
<body class="${param.skin}">
	<!-- data-confirm=true 提交前需要确认 -->
	<form:form cssClass="form-horizontal" id="fundSideInfoUpdForm" cssStyle="padding-top: 40px" modelAttribute="fundSideInfo"
		 method="post" action="${ctx}/fundSideInfo/upd.in" data-confirm="true">
