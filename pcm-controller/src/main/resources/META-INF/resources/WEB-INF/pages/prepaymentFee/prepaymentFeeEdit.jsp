...
<title><spring:message code="prepaymentFee.update.title" text="提前还款手续费修改" /></title>
<%@ include file="/common/head.jsp"%>
</head>
<body class="${param.skin}">
	<!-- data-confirm=true 提交前需要确认 -->
	<form:form cssClass="form-horizontal" id="prepaymentFeeUpdForm" cssStyle="padding-top: 40px" modelAttribute="prepaymentFee" method="post" action="${ctx}/prepaymentFee/updPrepaymentFee.in" data-confirm="true">
		<form:hidden path="prepaymentFeeCode" />
		...
		<div class="form-group row">
			...
			<!-- 结算日期描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="prepaymentFee.balanceDate.desc" />
			</div>
		</div>			
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			if(value=='A'){
				...
				+'<select>');
				$('#balanceDate').val('${prepaymentFee.balanceDate}')
			}else if(value=='C'){
				var zzqParent = $('#balanceDate').parent('div');
				zzqParent.empty();
