...
<title><spring:message code="fundSideSettlementMethod.add.title" text="资金方理赔方式
新增" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="fundSideSettlementMethodAddForm" 
	cssStyle="padding-top: 40px" modelAttribute="fundSideSettlementMethod" method="post" action="${ctx}/fundSideSettlementMethod/addFundSideSettlementMethod.in" data-confirm="true">
	...
	<script type="text/javascript">
		//开启表单验证
		$("#fundSideSettlementMethodAddForm").validate();
	</script>
</body>
</html>