...
<title><spring:message code="pacificInsuranceAgencyDedit.add.title" text="太保违约金收入新增" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="pacificInsuranceAgencyDeditAddForm" cssStyle="padding-top: 40px" modelAttribute="pacificInsuranceAgencyDedit" method="post" action="${ctx}/pacificInsuranceAgencyDedit/addPacificInsuranceAgencyDedit.in" data-confirm="true">
		<div class="form-group row">
			<!-- 违约金编码 -->
			<label class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label ">
				<span class="span-icon">*&nbsp;</span>
				<spring:message code="pacificInsuranceAgencyDedit.deditCode" text="违约金描述" />
				:
			</label>
			...
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="pacificInsuranceAgencyDedit.deditCode.desc" />
			</div>
		</div>
		<div class="form-group row">
			<!-- 违约金描述 -->
	...
	<script type="text/javascript">
		//开启表单验证
		$("#pacificInsuranceAgencyDeditAddForm").validate();
