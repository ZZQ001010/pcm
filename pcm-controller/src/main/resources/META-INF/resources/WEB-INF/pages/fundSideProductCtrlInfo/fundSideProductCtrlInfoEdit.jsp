...
<title><spring:message code="fundSideProductCtrlInfo.update.title" text="资金方产品经营控制
修改" /></title>
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="fundSideProductCtrlInfoUpdForm" cssStyle="padding-top: 40px" modelAttribute="fundSideProductCtrlInfo" method="post" action="${ctx}/fundSideProductCtrlInfo/updFundSideProductCtrlInfo.in" data-confirm="true">
       ...
       <div class="form-group row">
            ...
            <div id="districtBox" class="col-lg-7 col-md-7  col-sm-6 col-xs-12" >
                <form:select cssClass="form-control" path="fundSideDistrict" id="fundSideDistrict" name="fundSideDistrict">
                    <option value=""><spring:message code="kite.web.common.pleaseChoose" text="--请选择--" /></option>
                     <form:options items="${fundSideDistrict}" />  
                </form:select>
            </div>
        </div>
	...
	<script type="text/javascript">
		//开启表单验证
		$("#fundSideProductCtrlInfoUpdForm").validate();
