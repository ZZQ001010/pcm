...
<title><spring:message code="msgTemplate.update.title" text="短信模板修改" /></title>
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="bMPMessageTemplateUpdForm" cssStyle="width: 90%; padding-top: 40px" modelAttribute="bMPMessageTemplate" method="post" action="${ctx}/msgTemplate/updMsgTemplate.in" data-confirm="true">
		...
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-5">
				...
				<form:input class='form-control customize-datetime' value="${startTimeFmt }" data-picker-position="top-right" data-role-formate="yyyy-mm-dd" path="startTime" onfocus="this.blur()"  />
		...
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-5">
				...
				<form:input class='form-control customize-datetime' value="${endTimeFmt }" data-picker-position="top-right" data-role-formate="yyyy-mm-dd" path="endTime" onfocus="this.blur()"  />
				<i class="fa fa-calendar input_date" ></i>
			</div>
			<!-- 发送结束时间描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-3 remark">
	...
	<script>
		//开启表单验证
		$("#bMPMessageTemplateUpdForm").validate();
	</script>
</body>
