...
<title><spring:message code="mcc.add.title" text="MCC参数管理新增" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="mccAddForm" cssStyle="padding-top: 40px;padding-right: 40px" modelAttribute="mcc" method="post" action="${ctx}/mcc/addMcc.in" data-confirm="true">
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:input cssClass="form-control" type="text" path="mcc"  data-rule-required="true" data-rule-maxlength="4" />
			</div>
			<!-- 国际组织MCC代码描述 -->
		...
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:select cssClass="form-control" path="inputSource">
					<form:options items="${inputSource}" />
				</form:select>
			</div>
			<!-- 接入卡组织描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
