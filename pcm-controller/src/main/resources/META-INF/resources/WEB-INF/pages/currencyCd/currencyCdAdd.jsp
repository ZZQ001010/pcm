...
<title><spring:message code="currencyCd.add.title" text="货币代码管理新增" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="currencyCdAddForm" cssStyle="padding-top: 40px" modelAttribute="currencyCd" method="post" action="${ctx}/currencyCd/addCurrencyCd.in" data-confirm="true">
