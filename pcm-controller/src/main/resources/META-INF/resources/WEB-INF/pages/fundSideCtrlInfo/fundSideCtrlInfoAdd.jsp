...
<title><spring:message code="fundSideCtrlInfo.add.title" text="资金方管控信息
新增" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="fundSideCtrlInfoAddForm" cssStyle="padding-top: 40px" modelAttribute="fundSideCtrlInfo" method="post" action="${ctx}/fundSideCtrlInfo/addFundSideCtrlInfo.in" data-confirm="true">
		<div class="form-group row">
			...
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="fundSideCtrlInfo.fundSideCtrlCode.desc" />
			</div>
		</div>
		<div class="form-group row">
			<!-- 资金方管控描述 -->
	...
	<script type="text/javascript">
		//开启表单验证
		$("#fundSideCtrlInfoAddForm").validate();
	</script>
</body>
</html>