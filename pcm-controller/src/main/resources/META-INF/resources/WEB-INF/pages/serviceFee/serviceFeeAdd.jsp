...
<title><spring:message code="serviceFee.add.title" text="服务方服务费新增" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="serviceFeeAddForm" cssStyle="padding-top: 40px" modelAttribute="serviceFee" method="post" action="${ctx}/serviceFee/addServiceFee.in" data-confirm="true">
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:input cssClass="form-control" type="text" path="serviceFeeNo" data-rule-required="true" data-rule-maxlength="15" />
			</div>
			<!-- 服务方服务费编码描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="serviceFee.serviceFeeNo.desc" />
			</div>
		</div>
		<div class="form-group row">
			<!-- 服务方服务费描述 -->
		...
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:select cssClass="form-control" path="feeCollectionMethod" data-rule-required="true" id="feeCollectionMethod">
		...
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:input cssClass="form-control" type="text" path="chargeAmount"  data-rule-maxlength="12" data-rule-min="0"/>
			</div>
			<!-- 收取金额描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
