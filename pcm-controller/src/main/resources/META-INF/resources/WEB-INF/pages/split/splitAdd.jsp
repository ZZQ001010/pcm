...
<title><spring:message code="split.add.title" text="扣款拆分新增" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="splitAddForm" cssStyle="padding-top: 40px;padding-right: 40px" modelAttribute="split" method="post" action="${ctx}/split/addSplit.in" data-confirm="true">
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:input cssClass="form-control" type="text" path="splitTableId"  data-rule-required="true" data-rule-maxlength="6" />
			</div>
			<!-- 拆分表id描述 -->
		...
		<div class="form-group row" id="splitRate">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:input cssClass="form-control" type="text" path="splitRate" data-rule-required="true" data-rule-number="true" data-rule-min="0" data-rule-max="99.9999" />
			</div>
			<!-- 拆分比例描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
		...
		<div class="form-group row" id="splitAMT">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:input cssClass="form-control" type="text" path="splitAMT" data-rule-required="true" data-rule-number="true" data-rule-min="0" data-rule-max="9999999999999.99" />
			</div>
			<!-- 拆份固定金额描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
