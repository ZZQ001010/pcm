...
<title><spring:message code="fundSideServiceFee.update.title" text="资金方技术服务费修改" /></title>
<%@ include file="/common/head.jsp"%>
</head>
<body class="${param.skin}">
	<!-- data-confirm=true 提交前需要确认 -->
	<form:form cssClass="form-horizontal" id="fundSideServiceFeeUpdForm" cssStyle="padding-top: 40px" modelAttribute="fundSideServiceFee" method="post" action="${ctx}/fundSideServiceFee/updFundSideServiceFee.in" data-confirm="true">
	...
	<script type="text/javascript">
		//开启表单验证
		$("#fundSideServiceFeeUpdForm").validate();
