...
<title><spring:message code="bankPrincipalInterest.update.title" text="银行本息修改" /></title>
<%@ include file="/common/head.jsp"%>
</head>
<body class="${param.skin}">
	<!-- data-confirm=true 提交前需要确认 -->
	<form:form cssClass="form-horizontal" id="bankPrincipalInterestUpdForm" cssStyle="padding-top: 40px" modelAttribute="bankPrincipalInterest" method="post" action="${ctx}/bankPrincipalInterest/updBankPrincipalInterest.in" data-confirm="true">
		<form:hidden path="bankPrincipalInterestCode" />
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
                <form:input cssClass="form-control" type="text" path="bankPrincipalInterestDesc" data-rule-required="true" data-rule-maxlength="15" />
            </div>
            <!-- 银行本息描述 -->
	...
	<script type="text/javascript">
		//开启表单验证
		$("#bankPrincipalInterestUpdForm").validate();
        $(function(){
            //初始化数据
            typeChange();
        });
        ...
        $(function(){
            ...
            if(value=='A'){
                ...
                zzqParent.append('<select id="balanceDate" name="balanceDate"  class="form-control">'
                    ...
                    +'<select>');
                $('#balanceDate').val('${bankPrincipalInterest.balanceDate}')
            }else if(value=='C'){
                var zzqParent = $('#balanceDate').parent('div');
                zzqParent.empty();
