...
<title><spring:message code="insuranceProductInfo.update.title" text="保险产品信息修改" /></title>
<%@ include file="/common/head.jsp"%>
</head>
<body class="${param.skin}">
	<!-- data-confirm=true 提交前需要确认 -->
	<form:form cssClass="form-horizontal" id="insuranceProductInfoUpdForm" cssStyle="padding-top: 40px" modelAttribute="insuranceProductInfo" method="post" action="${ctx}/insuranceProductInfo/updInsuranceProductInfo.in" data-confirm="true">
	...
	<script type="text/javascript">
		//开启表单验证
		$("#insuranceProductInfoUpdForm").validate();
	</script>
</body>
</html>