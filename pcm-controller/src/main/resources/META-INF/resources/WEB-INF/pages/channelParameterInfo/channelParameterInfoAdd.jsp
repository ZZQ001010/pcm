...
<title><spring:message code="channelParameterInfo.add.title" text="渠道参数信息新增" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="channelParameterInfoAddForm" cssStyle="padding-top: 40px" modelAttribute="channelParameterInfo" method="post" action="${ctx}/channelParameterInfo/addChannelParameterInfo.in" data-confirm="true">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
                <form:select cssClass="form-control" path="channelAttributionType" data-rule-required="true">
	...
	<script type="text/javascript">
		//开启表单验证
		$("#channelParameterInfoAddForm").validate();
