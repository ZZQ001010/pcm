...
<title><spring:message code="channelInfo.update.title" text="渠道方基本信息修改" /></title>
<%@ include file="/common/head.jsp"%>
</head>
<body class="${param.skin}">
	<!-- data-confirm=true 提交前需要确认 -->
	<form:form cssClass="form-horizontal" id="channelInfoUpdForm" cssStyle="padding-top: 40px" modelAttribute="channelInfo" method="post" action="${ctx}/channelInfo/updChannelInfo.in" data-confirm="true">
