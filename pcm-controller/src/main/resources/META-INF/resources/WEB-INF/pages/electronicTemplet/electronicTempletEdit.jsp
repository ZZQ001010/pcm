...
<title><spring:message code="electronicTemplet.update.title" text="风控电子资料模板管理修改" /></title>
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="electronicTempletUpdForm" cssStyle="padding-top: 40px;padding-right: 40px" modelAttribute="electronicTemplet" data-confirm="true">
		<div class="form-group row">
			...
			<div class="col-lg-6 col-md-6  col-sm-5 col-xs-5">
				<form:input cssClass="form-control" type="text" path="templetId" data-rule-required="true" data-rule-maxlength="3" readonly="true" />
			</div>
			<!-- 模板编号描述 -->
	...
	<script>
		for (var key in ${templetList}) {
			$("#"+key).val(${templetList}[key]);
		}
		//开启表单验证
		$("#electronicTempletUpdForm").validate();
		$("#submit").click(function(){
			if($("#electronicTempletUpdForm").valid()){
				layer.confirm('确定提交?', {icon: 3, title:'提示'}, function(index){
					var vElectronicTemplet={};
					var templetList={};
					var form = $('#electronicTempletUpdForm').serializeArray();
					$.each(form, function() {
					...
					$K.ajax({
						url:"${ctx}/electronicTemplet/updElectronicTemplet.in",
						type:"post",
