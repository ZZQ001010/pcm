...
<title><spring:message code="mulct.add.title" text="罚金利率新增" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="mulctAddForm" cssStyle="padding-top: 40px" modelAttribute="mulct" method="post" action="${ctx}/mulct/addMulct.in" data-confirm="true">
		...
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<label class="col-lg-1 col-md-1 col-sm-1 col-xs-1 control-label">
					<input id="isReviewMulct" type="checkbox" class="js-switch" unchecked/>
					<form:hidden path="isReviewMulct" value="N"/>	
				</label>		
			</div>
			<!-- 扣款延迟入账是否回溯罚金描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
	...
	<script type="text/javascript">
		...
		//开启表单验证
		$("#mulctAddForm").validate();
		$("#submit").click(function(){
			if($("#mulctAddForm").valid()){
				layer.confirm('<spring:message code="mulctDef.common.confirmsubmit" text="确定提交" />', {icon: 3, title:'<spring:message code="kite.web.common.tip" text="提示" />',btn:["<spring:message code='kite.web.common.btnSure' text='确定' />","<spring:message code='kite.web.common.btnBack' text='取消' />"]}, 
						function(index){							
							var vMulct={};
							var form = $('#mulctAddForm').serializeArray();
							$.each(form, function() {
