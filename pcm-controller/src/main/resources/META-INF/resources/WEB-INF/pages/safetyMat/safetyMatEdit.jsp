...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="safetyMatAddForm" cssStyle="padding-top: 40px" modelAttribute="safetyMat" method="post" action="${ctx}/safetyMat/updSafetyMat.in" data-confirm="true">
		...
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:input cssClass="form-control" type="text" path="transferAccount"  data-rule-required="true" data-rule-maxlength="12" />
			</div>
			<!-- 转出账号描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
		...
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:input cssClass="form-control" type="text" path="transferToAccount"  data-rule-required="true" data-rule-maxlength="12" />
			</div>
			<!-- 转入账号描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
