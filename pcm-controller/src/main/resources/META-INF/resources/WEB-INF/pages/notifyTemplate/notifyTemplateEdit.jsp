...
<title><spring:message code="notifyTemplate.update.title" text="通知模板管理修改" /></title>
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="notifyTemplateUpdForm" cssStyle="padding-top: 40px;padding-right: 100px" modelAttribute="notifyTemplate" method="post" action="${ctx}/notifyTemplate/updNotifyTemplate.in" data-confirm="true">
		<div class="form-group row">
			...
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6" style="margin-top: 8px;">
				<form:input cssClass="form-control" path="notifyCode"  readonly='true' data-rule-required="true" data-rule-maxlength="80" />
			</div>
			<!-- 通知名称 -->
			<label class="col-lg-2 col-md-3 col-sm-6 col-xs-6 control-label">
			...
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6" style="margin-top: 8px;">
				<form:input cssClass="form-control" path="noticeName" data-rule-maxlength="80" />
			</div>
			<!-- 通知代码描述 -->
			...
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6" style="margin-top: 8px;">
				<form:input cssClass="form-control" path="cooperationChannel" data-rule-maxlength="80" />
			</div>
			<!-- 合作机构描述 -->
			<div class="hide remark">
		...
		<div class="form-group row"> -->
			...
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6" style="margin-top: 8px;">
				<form:input cssClass="form-control" path="sendUrl" data-rule-required="true" data-rule-maxlength="80" />
			</div>
			<!-- 发送地址描述 -->
			<div class="hide remark">
		...
		<div class="form-group row"> -->
			<!-- 重发时间间隔 -->
			<label class="col-lg-2 col-md-3 col-sm-6 col-xs-6 control-label">
				<span class="span-icon" id='reDate'>*&nbsp;</span>
				<spring:message code="notifyTemplate.repeatInterval" text="重发时间间隔" />
				:
			</label>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6" style="margin-top: 8px;">
				<form:input cssClass="form-control" path="repeatInterval" data-rule-required="true" data-rule-digits="true" data-rule-min="0" data-rule-max="99999" />
			</div>
			<!-- 重发时间间隔描述 -->
			<div class="hide remark">
		...
		<div class="form-group row"> -->
			<!-- 重发次数上限 -->
			<label class="col-lg-2 col-md-3 col-sm-6 col-xs-6 control-label">
				<span class="span-icon" id='reCount'>*&nbsp;</span>
				<spring:message code="notifyTemplate.maxRepeat" text="重发次数上限" />
				:
			</label>
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6" style="margin-top: 8px;">
				<form:input cssClass="form-control" path="maxRepeat" data-rule-required="true" data-rule-digits="true" data-rule-min="0" data-rule-max="99999" />
			</div>
			<!-- 重发次数上限描述 -->
			<div class="hide remark">
			...
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6" style="margin-top: 8px;">
				<form:input cssClass="form-control" path="sendTimeLapse" data-rule-digits="true" data-rule-min="0" data-rule-max="99999" />
			</div>
			<!-- 发送延时时间描述 -->
			<div class="hide remark">
		...
		<div class="form-group row"> -->
			...
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6" style="margin-top: 8px;"> 
				<form:input cssClass="form-control" path="respCode" data-rule-maxlength="1200" />
			</div>
			<!-- 响应码描述 -->
			<div class="hide remark">
		...
		<div class="form-group row"> -->
			...
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6" style="margin-top: 8px;">
				<form:input cssClass="form-control" path="respValue" data-rule-maxlength="80" />
			</div>
			<!-- 响应值描述 -->
			<div class="hide remark">
		...
		<div class="form-group row"> -->
			...
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6" style="margin-top: 8px;">
				<form:input cssClass="form-control" path="lengthSize" data-rule-maxlength="8" />
			</div>
			<!-- 报文长度位数描述 -->
			<div class="hide remark">
			...
			<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6" style="margin-top: 20px;">
		...
		<div class="form-group row">
			...
			<div class="col-lg-10 col-md-9 col-sm-6 col-xs-6" >
				<form:textarea cssClass='form-control noresize' path="notifyTemplate" rows="5" data-rule-required="true" />
			</div>
			<!-- 通知模板描述 -->
			<div class="hide remark">
	...
	<script type="text/javascript">
		...
		$(".js-switch").each(function(i, ck) {
			...
			$(this).change(function() {
				...
				//如果当前选择的是是否需要重发
				if($(this).is(":checked")&&$(this).attr("id")=='isRepeat'){
					showOrHide()
		...
		function showOrHide(){
			$("#reDate").show();
			$("#repeatInterval").data("rule-required",true)
			$("#reCount").hide();
			$("#maxRepeat").data("rule-required",false)
		}
