...
<title><spring:message code="phyCardCd.update.title" text="卡面代码参数修改" /></title>
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="phyCardCdUpdForm" cssStyle="padding-top: 40px;padding-right: 40px" modelAttribute="phyCardCd" method="post" action="${ctx}/phyCardCd/updPhyCardCd.in" data-confirm="true">
		<div class="form-group row">
			<!-- 卡片代码 -->
			<label class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label">
				<span class="span-icon">*&nbsp;</span>
				<spring:message code="phyCardCd.pyhCd" text="卡片代码" />
				:
			</label>
		...
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:input cssClass="form-control" type="text" path="embossFileName"  data-rule-required="true" data-rule-maxlength="40" />
			</div>
			<!-- 卡面制卡文件描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
	...
	<script>
		//开启表单验证
		$("#phyCardCdUpdForm").validate();
		$("#pyhCd").attr("disabled", true).css("background-color","#EEEEEE;");;
	</script>
</body>
