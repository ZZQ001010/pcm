...
<title><spring:message code="serverInfo.add.title" text="服务方基本信息新增" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="serverInfoAddForm" cssStyle="padding-top: 40px" modelAttribute="serverInfo" method="post" action="${ctx}/serverInfo/addServerInfo.in" data-confirm="true">
		<div class="form-group row">
			<!-- 服务方编码 -->
			<label class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label ">
			<span class="span-icon">*&nbsp;</span>
				<spring:message code="serverInfo.serverCode" text="服务方描述" />
				:
			</label>
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:input cssClass="form-control" type="text" path="serverCode" data-rule-required="true"  data-rule-maxlength="15" />
			</div>
			<!-- 服务方编码描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="serverInfo.serverCode.desc" />
			</div>
		</div>
		<div class="form-group row">
			<!-- 服务方描述 -->
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:input cssClass="form-control" type="text" path="serverDesc" data-rule-required="true" data-rule-maxlength="50" />
			</div>
			<!-- 服务方描述描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
			...
			<!-- 市 -->	
				<div class="col-lg-2 col-md-1 col-sm-1 col-xs-1" id="cityBox">
					...
					<form:select cssClass="form-control" path="residence.city" id="city" >
						<option value=""><spring:message code="kite.web.common.pleaseChoose" text="--请选择--" /></option>
						<form:options items="${serverInfo.residence.city}" />
					</form:select>
				...
				<div class="col-lg-2 col-md-1 col-sm-1 col-xs-1" id="microdistrictBox">
					...
					<form:select cssClass="form-control" path="residence.microdistrict" id="microdistrict" >
						<option value=""><spring:message code="kite.web.common.pleaseChoose" text="--请选择--" /></option>
						<form:options items="${serverInfo.residence.microdistrict}" />
					</form:select>
