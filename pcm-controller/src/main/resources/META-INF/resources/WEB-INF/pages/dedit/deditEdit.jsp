...
<title><spring:message code="dedit.update.title" text="平台违约金修改" /></title>
<%@ include file="/common/head.jsp"%>
</head>
<body class="${param.skin}">
	<!-- data-confirm=true 提交前需要确认 -->
	<form:form cssClass="form-horizontal" id="deditUpdForm" cssStyle="padding-top: 40px" modelAttribute="dedit" method="post" action="${ctx}/dedit/updDedit.in" data-confirm="true">
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			if(value=='A'){
				...
				+'<select>');
				$('#balanceDate').val('${dedit.balanceDate}')
			}else if(value=='C'){
				var zzqParent = $('#balanceDate').parent('div');
				zzqParent.empty();
