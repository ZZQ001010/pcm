...
<title><spring:message code="pacificInsuranceAgencyDedit.update.title" text="太保违约金收入修改" /></title>
<%@ include file="/common/head.jsp"%>
</head>
<body class="${param.skin}">
	<!-- data-confirm=true 提交前需要确认 -->
	<form:form cssClass="form-horizontal" id="pacificInsuranceAgencyDeditUpdForm" cssStyle="padding-top: 40px" modelAttribute="pacificInsuranceAgencyDedit" method="post" action="${ctx}/pacificInsuranceAgencyDedit/updPacificInsuranceAgencyDedit.in" data-confirm="true">
		<form:hidden path="deditCode" />
		<div class="form-group row">
			...
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="pacificInsuranceAgencyDedit.deditDesc.desc" />
			</div>
		</div>				
		<div class="form-group row">
			<!-- 费用收取方式 -->
			...
			<!-- 费用收取方式描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="pacificInsuranceAgencyDedit.feeCollectionMethod.desc" />
			</div>
		</div>				
		<div class="form-group row">
			<!-- 费用收取基础 -->
			...
			<!-- 费用收取基础描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="pacificInsuranceAgencyDedit.feeBasis.desc" />
			</div>
		</div>				
		<div class="form-group row">
			<!-- 收取比例 -->
			...
			<!-- 收取比例描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="pacificInsuranceAgencyDedit.chargeRatio.desc" />
			</div>
		</div>				
		<div class="form-group row">
			<!-- 所属机构 -->
			...
			<!-- 所属机构描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="pacificInsuranceAgencyDedit.organization.desc" />
			</div>
		</div>				
		<div class="form-group row">
			<!-- 合作方类型 -->
			...
			<!-- 合作方类型描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="pacificInsuranceAgencyDedit.partnerType.desc" />
			</div>
		</div>				
		<div class="form-group row">
			<!-- 合作方编码 -->
		...
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:input cssClass="form-control" type="text" path="partnerCode"  data-rule-required="true" data-rule-maxlength="15" />
			</div>
			<!-- 合作方编码描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="pacificInsuranceAgencyDedit.partnerCode.desc" />
		...
		<div class="form-group row">
			...
			<!-- 转出账号描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="pacificInsuranceAgencyDedit.transferAccount.desc" />
			</div>
		</div>				
		<div class="form-group row">
			<!-- 转入账号 -->
			...
			<!-- 转入账号描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="pacificInsuranceAgencyDedit.transferToAccount.desc" />
			</div>
		</div>				
		<div class="form-group row">
			<!-- 结算周期 -->
			...
			<!-- 结算周期描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="pacificInsuranceAgencyDedit.billingCycle.desc" />
			</div>
		</div>				
		<div class="form-group row">
			<!-- 结算日期 -->
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:input cssClass="form-control" type="text" path="balanceDate"  data-rule-maxlength="12" />
			</div>
			<!-- 结算日期描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
	...
	<script type="text/javascript">
		//开启表单验证
		$("#pacificInsuranceAgencyDeditUpdForm").validate();
		...
		$(function(){
			...
			if(value=='A'){
				...
				+'<select>');
				$('#balanceDate').val('${pacificInsuranceAgencyDedit.balanceDate}')
			}else if(value=='C'){
				var zzqParent = $('#balanceDate').parent('div');
				zzqParent.empty();
