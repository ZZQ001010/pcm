...
<title><spring:message code="organization.update.title" text="机构参数管理修改" /></title>
<%@ include file="/common/head.jsp"%>
</head>
<body class="${param.skin}">
	<!-- data-confirm=true 提交前需要确认 -->
	<form:form cssClass="form-horizontal" id="organizationUpdForm" cssStyle="padding-top: 40px" modelAttribute="organization" method="post" action="${ctx}/organization/updOrganization.in" data-confirm="true">
