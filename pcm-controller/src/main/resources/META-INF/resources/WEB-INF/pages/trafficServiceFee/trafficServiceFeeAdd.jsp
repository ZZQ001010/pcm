...
<title><spring:message code="trafficServiceFee.add.title" text="流量服务费新增" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="trafficServiceFeeAddForm" cssStyle="padding-top: 40px" modelAttribute="trafficServiceFee" method="post" action="${ctx}/trafficServiceFee/addTrafficServiceFee.in" data-confirm="true">
		<div class="form-group row">
			...
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="trafficServiceFee.trafficServiceFeeCode.desc" />
			</div>
		</div>
		<div class="form-group row">
			<!-- 流量服务描述 -->
		...
		<div class="form-group row">
			...
			<label class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label">
			<span class="span-icon">*&nbsp;</span>
				<spring:message code="trafficServiceFee.partnerType" text="合作方类型" />
				:
			</label>
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
			...
			<!-- 合作方类型描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="trafficServiceFee.partnerType.desc" />
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<label class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label">
			<span class="span-icon">*&nbsp;</span>
				<spring:message code="trafficServiceFee.partnerCode" text="合作方编码" />
				:
			</label>
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
			...
			<!-- 合作方编码描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="trafficServiceFee.partnerCode.desc" />
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:input cssClass="form-control" type="text" path="transferAccount"   data-rule-digits="true" data-rule-min="0" data-rule-max="999999999999" />
			</div>
			<!-- 转出账号描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
	...
	<script type="text/javascript">
		//开启表单验证
		$("#trafficServiceFeeAddForm").validate();	
