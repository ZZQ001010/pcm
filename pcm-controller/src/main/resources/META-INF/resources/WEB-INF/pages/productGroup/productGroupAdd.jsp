...
<title><spring:message code="productGroup.add.title" text="产品页面分组表新增" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="tmProductGroupAddForm" cssStyle="padding-top: 40px" modelAttribute="tmProductGroup" method="post" action="${ctx}/productUnits/addProductGroup.in" data-confirm="true">
		<form:input  type="hidden" path="productParentId"   />
		...
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:input cssClass="form-control" type="text" path="groupCode"  data-rule-required="true" data-rule-maxlength="200" />
			</div>
			<!-- 分组编码描述 -->
	...
	<script>
		//开启表单验证
		$("#tmProductGroupAddForm").validate();
	</script>
</body>
</html>