...
<title><spring:message code="collectionService.add.title" text="催收服务费新增" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="collectionServiceAddForm" cssStyle="padding-top: 40px" modelAttribute="collectionService" method="post" action="${ctx}/collectionService/addCollectionService.in" data-confirm="true">
		<div class="form-group row">
			...
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="collectionService.code.desc" />
			</div>
		</div>
		<div class="form-group row">
			<!-- 催收服务描述 -->
	...
	<script type="text/javascript">
		//开启表单验证
		$("#collectionServiceAddForm").validate();
