	...
	<form:form cssClass="form-horizontal" cssStyle="padding-top: 40px;padding-right: 40px" modelAttribute="financialOrg" method="post">
		<div class="x_panel">
			...
			<!-- 预理赔起始天数 -->
					...
					<label class="col-lg-7 col-md-7 col-sm-7 col-xs-7 detailStyle"> &nbsp;${financialOrg.preClaimStartDays } </label>
				</div>
				<div class="form-group row">
					<!-- 预理赔终止天数 -->
					<label class="ccol-lg-5 col-md-5 col-sm-5 col-xs-5  control-label">
					...
					<label class="col-lg-7 col-md-7 col-sm-7 col-xs-7 detailStyle"> &nbsp;${financialOrg.preClaimEndDays } </label>
				</div>
				<div class="form-group row">
					<!-- 理赔天数 -->
					<label class="ccol-lg-5 col-md-5 col-sm-5 col-xs-5  control-label">
					...
					<label class="col-lg-7 col-md-7 col-sm-7 col-xs-7 detailStyle"> &nbsp;${financialOrg.claimsDays } </label>
				</div>
				<div class="form-group row">
					<!-- 提前还款手续费分成比例 -->
					<label class="col-lg-2 col-md-3 col-sm-4 col-xs-6 control-label">
