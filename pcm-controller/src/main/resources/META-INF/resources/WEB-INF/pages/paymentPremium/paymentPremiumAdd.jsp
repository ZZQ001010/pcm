...
<title><spring:message code="paymentPremium.add.title" text="保费垫付新增" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="paymentPremiumAddForm" cssStyle="padding-top: 40px" modelAttribute="paymentPremium" method="post" action="${ctx}/paymentPremium/addPaymentPremium.in" data-confirm="true">
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:input cssClass="form-control" type="text" path="paymentPremiumCode"  data-rule-maxlength="50" data-rule-required="true" />
			</div>
			<!-- 保费垫付编码描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="paymentPremium.paymentPremiumCode.desc" />
			</div>
		</div>
		<div class="form-group row">
			<!-- 保费垫付描述 -->
	...
	<script type="text/javascript">
		//开启表单验证
		$("#paymentPremiumAddForm").validate();
		//合作方编码控制
		function typeChange(){
