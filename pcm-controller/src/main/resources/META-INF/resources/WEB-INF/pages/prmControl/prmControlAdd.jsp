...
<title><spring:message code="prmControl.add.title" text="参数管控新增" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="tmPrmControlAddForm" cssStyle="padding-top: 40px" modelAttribute="tmPrmControl" method="post" action="${ctx}/prmControl/addPrmControl.in" data-confirm="true">
