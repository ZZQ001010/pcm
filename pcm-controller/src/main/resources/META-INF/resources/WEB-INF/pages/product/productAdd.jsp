...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal form-product"  id="productAddForm" cssStyle="padding-top: 20px" modelAttribute="product" method="post" action="${ctx}/product/addProduct.in" data-confirm="true">
