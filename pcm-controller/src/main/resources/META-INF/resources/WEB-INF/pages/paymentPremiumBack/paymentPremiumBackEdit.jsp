...
<title><spring:message code="paymentPremiumBack.update.title" text="保费垫付返还修改" /></title>
<%@ include file="/common/head.jsp"%>
</head>
<body class="${param.skin}">
	<!-- data-confirm=true 提交前需要确认 -->
	<form:form cssClass="form-horizontal" id="paymentPremiumBackUpdForm" cssStyle="padding-top: 40px" modelAttribute="paymentPremiumBack" method="post" action="${ctx}/paymentPremiumBack/updPaymentPremiumBack.in" data-confirm="true">
		<form:hidden path="paymentPremiumBackCode" />
	...
	<script type="text/javascript">
		//开启表单验证
		$("#paymentPremiumBackUpdForm").validate();
		//合作方编码控制
		function typeChange(){
		...
		$(function(){
			...
			if(value=='A'){
				...
				+'<select>');
				$('#balanceDate').val('${paymentPremiumBack.balanceDate}')
			}else if(value=='C'){
				var zzqParent = $('#balanceDate').parent('div');
				zzqParent.empty();
