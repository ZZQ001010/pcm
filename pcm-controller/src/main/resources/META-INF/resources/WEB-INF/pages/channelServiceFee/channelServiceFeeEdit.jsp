...
<title><spring:message code="channelServiceFee.update.title" text="渠道方服务费修改" /></title>
<%@ include file="/common/head.jsp"%>
</head>
<body class="${param.skin}">
	<!-- data-confirm=true 提交前需要确认 -->
	<form:form cssClass="form-horizontal" id="channelServiceFeeUpdForm" cssStyle="padding-top: 40px" modelAttribute="channelServiceFee" method="post" action="${ctx}/channelServiceFee/updChannelServiceFee.in" data-confirm="true">
		<form:hidden path="channelServiceCode" />
		...
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:input cssClass="form-control" type="text" path="chargeAmount" id="chargeAmount" data-rule-min="0" data-rule-maxlength="12" />
			</div>
			<!-- 收取金额描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
	...
	<script type="text/javascript">
		//开启表单验证
		$("#channelServiceFeeUpdForm").validate();
		...
		$(function(){
			...
			if(value=='A'){
				...
				+'<select>');
				$('#balanceDate').val('${channelServiceFee.balanceDate}')
			}else if(value=='C'){
				var zzqParent = $('#balanceDate').parent('div');
				zzqParent.empty();
