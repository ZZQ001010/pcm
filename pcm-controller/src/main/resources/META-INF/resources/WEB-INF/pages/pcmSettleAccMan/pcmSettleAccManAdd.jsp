	...
	<form:form cssClass="form-horizontal" id="pcmSettleAccManAddForm" cssStyle="padding-top: 40px" modelAttribute="pcmSettleAccMan" method="post" action="${ctx}/pcmSettleAccMan/addPcmSettleAccMan.in" data-confirm="true">
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				<form:input cssClass="form-control" type="text" path="settleAccCode"  data-rule-maxlength="100"  data-rule-required="true" />
			</div>
			<!-- 结算账号编码描述 -->
		...
		<div class="form-group row">
			...
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
				...
				<!-- <form:input cssClass="form-control" type="text" path="vOpenBankCity"  data-rule-maxlength="32" /> -->
			</div>
			<!-- 开户行城市描述 -->
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
