...
<title><spring:message code="pcmOrgParameter.add.title" text="机构参数新增" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="pcmOrgParameterAddForm" cssStyle="padding-top: 40px" modelAttribute="pcmOrgParameter" method="post" action="${ctx}/pcmOrgParameter/addPcmOrgParameter.in" data-confirm="true">
		<div class="form-group row">
			...
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="pcmOrgParameter.orgCode.desc" />
			</div>
		</div>
		<div class="form-group row">
			<!-- 机构名称 -->
		...
		<div class="form-group row">
			<!-- 注册资本货币代码  -->
			<label class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label">
				<spring:message code="regCapitalCurrencyCod" text="注册资本货币代码 " />
				:
			</label>
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
		...
		<div class="form-group row">
			<!-- 统一社会信用代码 -->
			<label class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label">
				<spring:message code="unifiedSocialCreditCode" text="统一社会信用代码" />
				:
			</label>
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
		...
		<div class="form-group row">
			<!-- 组织机构代码  -->
			<label class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label">
				<spring:message code="organizationCode" text="组织机构代码 " />
				:
			</label>
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
		...
		<div class="form-group row">
			<!-- 税务登记号码  -->
			<label class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label">
				<spring:message code="taxRegNum" text="税务登记号码 " />
				:
			</label>
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
		...
		<div class="form-group row">
			<!-- 监管辖区代码 -->
			<label class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label">
				<spring:message code="supervisoryJurisdictionCod" text="监管辖区代码" />
				:
			</label>
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
		...
		<div class="form-group row">
			<!-- 注册地  -->
			<label class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label">
				<spring:message code="registration" text="注册地 " />
				:
			</label>
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
		...
		<div class="form-group row">
			<!-- 经营场所邮编 -->
			<label class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label">
				<spring:message code="busPlaceZipCode" text="经营场所邮编" />
				:
			</label>
			<div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
	...
	<script type="text/javascript">
		//开启表单验证
		$("#pcmOrgParameterAddForm").validate();
	</script>
</body>
</html>