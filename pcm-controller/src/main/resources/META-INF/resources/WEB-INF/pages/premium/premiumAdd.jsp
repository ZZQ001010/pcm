...
<title><spring:message code="premium.add.title" text="保费新增" /></title>
<!-- 引入css样式和部分js -->
...
<body class="${param.skin}">
	...
	<form:form cssClass="form-horizontal" id="premiumAddForm" cssStyle="padding-top: 40px" modelAttribute="premium" method="post" action="${ctx}/premium/addPremium.in" data-confirm="true">
		<div class="form-group row">
			...
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4 remark">
				<spring:message code="premium.premiumCode.desc" />
			</div>
		</div>
		<div class="form-group row">
			<!-- 保费描述 -->
        ...
        <div class="form-group row">
            ...
            <label class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label">
                <span class="span-icon">&nbsp;</span>
                <spring:message code="premium.expenses" text="费用累计月天数" />
                :
            </label>
            <div class="col-lg-7 col-md-7 col-sm-6 col-xs-6">
